...
const DiscordIcon = () => (
  <svg viewBox="0 0 24 24" className="h-4.5 w-4.5 fill-[#5865F2]" aria-hidden="true">
...
/**
 * Quiet OAuth chips per the journey handoff (`.j-oauth`) — transparent
 * fill, strong hairline, gold border on hover. Brand icons keep their
 * own colors.
 */
