...
import { confirmMpmbImportPreview } from "@/app/(app)/homebrew/import/actions";
...
export default async function MpmbImportPreviewPage({
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-7">
      <Link
        href={`/homebrew/import/${preview.id}`}
      ...
      <div className="flex flex-col gap-3 border-t border-border pt-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        {preview.previewValidated ? (
          <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:items-center">
            ...
            <Link href={`/homebrew/import/${preview.id}`} className={buttonVariants({ variant: "gold" })}>
              Return to import
            </Link>
          </div>
        ) : (
